                ...
                <form method="POST" action="{{ route('admin.products.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="mb-4">
                        ...
                        <select name="category_id" id="category_id" required
                            ...
                            <option value="" disabled {{ old('category_id') ? '' : 'selected' }} hidden>Choose Product Category</option>
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="about" id="about" rows="5"
                            class="border border-gray-300 rounded-xl w-full shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white dark:focus:ring-indigo-600 py-2 px-3">{{ old('about') }}</textarea>
                        @error('about')
                        <p class="mt-2 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                        @enderror
                    </div>
                    <div class="mb-4">
                        <label for="photo" class="block font-medium text-sm text-gray-700 dark:text-gray-300">
                            {{ __('Photo') }}
                        </label>
