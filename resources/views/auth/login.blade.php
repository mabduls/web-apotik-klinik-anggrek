...
<body class="bg-gradient-to-br from-purple-50 via-blue-50 to-pink-50 relative overflow-hidden">
        ...
        <div class="form-container slide-in">
            ...
            <div class="gradient-border">
                <div class="glass-effect rounded-3xl overflow-hidden">
                    <!-- Header Section -->
                    <div class="text-center p-6 md:p-8 bg-gradient-to-r from-purple-100 via-blue-100 to-pink-100">
                        ...
                        <p class="text-gray-600 mt-1 text-sm">Sign in to continue your journey</p>
                    </div>
                        ...
                        <form method="POST" action="{{ route('login') }}" class="space-y-4">
                            ...
                            <div class="flex items-center justify-between pt-1">
                                ...
                                <a href="{{ route('password.request') }}"
                                    class="text-xs font-medium text-purple-500 hover:text-purple-400 transition-colors">
                                    Forgot password?
                                </a>
                                @endif
                            </div>
                            ...
                            <!-- Login Button -->
                            <button type="submit"
                                class="w-full py-3 px-6 bg-gradient-to-r from-purple-400 to-pink-400 
                                hover:from-purple-500 hover:to-pink-500 text-white font-semibold 
                                rounded-2xl btn-hover focus:outline-none focus:ring-4 
                                focus:ring-purple-300 focus:ring-opacity-50 mt-4">
                        ...
                        <div class="mt-6 space-y-3">
                            <div class="text-center">
                                <a href="{{ route('welcome') }}"
                                    class="inline-flex items-center text-xs font-medium text-gray-500 hover:text-purple-500 transition-colors">
                            ...
                            <div class="text-center">
                                ...
                                <a href="{{ route('register') }}"
                                    class="text-xs font-semibold text-purple-500 hover:text-purple-400 transition-colors">
                                    Create Account
                                </a>
                            </div>
                        </div>
